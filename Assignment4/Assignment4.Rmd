...
gene_weights <- t(learner$) %*% model$coefs
...
signature_genes_LR_10_50 <- colnames(top_10_labeled)[signature_indices]
...
# Get the genes by column index
signature_indices <- which(abs(as.numeric(gene_weights)) > threshold)
signature_genes_LR_100_99 <- colnames(top_100_labeled)[signature_indices]
...
# Get the genes by column index
signature_indices <- which(abs(as.numeric(gene_weights)) > threshold)
signature_genes_LR_1000_99 <- colnames(top_1000_labeled)[signature_indices]
...
# Get the genes by column index
signature_indices <- which(abs(as.numeric(gene_weights)) > threshold)
signature_genes_LR_5000_99 <- colnames(top_5000_labeled)[signature_indices]
...
# Get the genes by column index
signature_indices <- which(abs(as.numeric(gene_weights)) > threshold)
signature_genes_LR_10000_999 <- colnames(top_10000_labeled)[signature_indices]
