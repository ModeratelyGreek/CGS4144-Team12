...
1.  Unsupervised Analysis
    ...
    d.  How many clusters did each method find?
        a.  If you ran a method that requires you to select the number
            of clusters (k), how did changing\
            this value change the results? Compare cluster membership at
            each k to investigate this.
...
ht = ComplexHeatmap::Heatmap(copy_1000,heatmap_legend_param = list(
        title = "Expression", at = c(0, 50, 100,150)
    ),column_title = "Clustered Genes",show_column_names = FALSE,cluster_columns = FALSE,cluster_rows = FALSE)
...
### 🚨🚨🚨🚨🚨🚨🚨🚨🚨Everything Below this Point is Assignment 2 🚨🚨🚨🚨🚨🚨🚨🚨🚨
